        ...
        <div className='flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12'>
          ...
          >
            <p className='text-xs md:text-sm tracking-widest uppercase text-gray-500 mb-2'>
              Sản phẩm cho cuộc sống tốt đẹp hơn
            </p>
            <h1 className='text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-4 leading-tight'>
              Tương lai tốt đẹp hơn
            </h1>
            <p className='text-gray-600 mb-6 max-w-xl md:max-w-none md:pr-6'>
              Hãy để tình yêu được nói ra, hãy để tình yêu công bằng cho đến tận cùng thời gian. Nỗi đau bệnh tật không khuất phục trước tiếng cười.
            </p>
